...
--
-- Host: localhost
-- Generation Time: Feb 11, 2014 at 04:55 PM
...
INSERT INTO `jobs` (`job_id`, `client_id`, `user_id`, `name`, `start_date`, `finish_date`, `createdon`) VALUES
(1, 1, 1, 'Hello Festival', 0, 0, '2014-02-10 23:52:28'),
(2, 1, 1, 'Hello Festival', 0, 0, '2014-02-10 23:59:12');
...
(1, 1, 1, 1, 0, 0, 'propagate.au@gmail.com', 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'Mr', 'Pro', 'Gate', 'Pro Pa Gate', '20A Macquaire St', 'Prahran', 'Melbourne', 'VIC', '3181', '', 'AU', '', '2014-02-11 14:13:01', '2014-02-05 19:22:44', '2014-02-11 09:52:22'),
...
(1, 31, '', 'Propagate', 0, '12 345 567 789');
...
(26, 1, 0, '', 1.40, 'm', '', '', '', 0, 0, 1, 'Single', 1, 'HELP + SFSS', '', '', '', 1, '12 345 567 789', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '["8","10","11","1","4"]', '{"3":["21","23"],"4":["27","28","29","30","31"]}');
