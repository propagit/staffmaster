...
<div class="row">
	...
	<div class="col-md-6"><b>$<?=money_format('%i', SMS_PRICE);?> (ex. GST)</b></div>
</div>
<hr />
<div class="row">
	<div class="col-md-4 remove-left-padding">Sub total</div>
	<div class="col-md-6"><b>$<?=money_format('%i', SMS_PRICE * $credits);?></b></div>
</div>
<hr />
<div class="row">
	<div class="col-md-4 remove-left-padding">GST</div>
	<div class="col-md-6"><b>$<?=money_format('%i', SMS_PRICE * $credits / 10);?></b></div>
</div>
<hr />
<div class="row">
	<div class="col-md-4 remove-left-padding">Total</div>
	<div class="col-md-6"><h2>$<?=money_format('%i', SMS_PRICE * $credits * 1.1);?></h2></div>
</div>
<?
