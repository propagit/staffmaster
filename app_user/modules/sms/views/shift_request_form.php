<form id="send-sms-form">
	...
	<textarea class="form-control" rows="4" name="msg" onkeyup="updateTextboxCounter('msg','currentChars');" onkeydown="updateTextboxCounter('msg','currentChars');" onkeypress="updateTextboxCounter('msg','currentChars');"><?=$request_sms['msg'];?>
	</textarea><br />
