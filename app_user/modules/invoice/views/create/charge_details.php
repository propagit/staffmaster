...
<tr>
	...
	<td align="right"><a href="#" class="inv_company_due_date prim-color-to-txt-color" data-type="date"  data-pk="<?=$invoice['invoice_id']?>" data-title="Due Date"><h4><?=date('jS M Y', strtotime($invoice['due_date']));?></h4></a></td>
</tr>
<tr>
