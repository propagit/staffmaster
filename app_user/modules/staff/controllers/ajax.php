	...
	*/
	...
	function update_super()
	{
		...
		$staff_data = array(
			...
			's_external_id' => isset($data['s_external_id']) ? $data['s_external_id'] : '',
			's_employee_id' => isset($data['s_employee_id']) ? $data['s_employee_id'] : '',
			's_fund_website' => isset($data['s_fund_website']) ? $data['s_fund_website'] : '',
			's_product_id' => isset($data['s_product_id']) ? $data['s_product_id'] : '',
			's_fund_phone' => isset($data['s_fund_phone']) ? $data['s_fund_phone'] : '',
			's_membership' => isset($data['s_membership']) ? $data['s_membership'] : '',
			's_fund_address' => isset($data['s_fund_address']) ? $data['s_fund_address'] : '',
			's_fund_suburb' => isset($data['s_fund_suburb']) ? $data['s_fund_suburb'] : '',
			's_fund_state' => isset($data['s_fund_state']) ? $data['s_fund_state'] : '',
			's_fund_postcode' => isset($data['s_fund_postcode']) ? $data['s_fund_postcode'] : '',
	...
	function send_sample_email()
	{
		...
		if($selected_user_ids){
			...
			foreach($user_ids as $user_id){
				...
				//break iteration for sample email
				break;
			}
		}
		echo 'success';
