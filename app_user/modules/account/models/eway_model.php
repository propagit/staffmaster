...
class Eway_model extends CI_Model {
	...
	// Possible fields: 
	// "TotalAmount", "CustomerFirstName", "CustomerLastName", "CustomerEmail"
	// "CustomerAddress", "CustomerPostcode", "CustomerInvoiceDescription", "CustomerInvoiceRef"
	// "CardHoldersName", "CardNumber", "CardExpiryMonth", "CardExpiryYear", "TrxnNumber"
	// "Option1", "Option2", "Option3", "CVN", "CustomerIPAddress", "CustomerBillingCountry"
