...
(function ($) {
    ...
    var Constructor = function (options) {
        this.init('typeaheadjs2', options, Constructor.defaults);
    };
    ...
    Constructor.defaults = $.extend({}, $.fn.editabletypes.list.defaults, {
        ...
        **/         
        tpl:
        	...
        	'</select>' + '<input type="text" class="form-control" placeholder="Enter staff name" />',
        /**
        Configuration of typeahead itself. 
        [Full list of options](https://github.com/twitter/typeahead.js#dataset).
    ...
    $.fn.editabletypes.typeaheadjs2 = Constructor;      
