...
$route['(job|staff|roster|work|timesheet)'] = 'dispatcher/user_dispatcher/$1';
$route['(job|staff|roster|work|timesheet)/(:any)'] = 'dispatcher/user_dispatcher/$1/$2';
$route['(job|staff|roster|work|timesheet)/(:any)/(:any)'] = 'dispatcher/user_dispatcher/$1/$2/$3';
$route['(job|staff|roster|work|timesheet)/(:any)/(:any)/(:any)'] = 'dispatcher/user_dispatcher/$1/$2/$3/$4';
