...
$route['(job|staff|roster|work|timesheet|payrun)'] = 'dispatcher/user_dispatcher/$1';
$route['(job|staff|roster|work|timesheet|payrun)/(:any)'] = 'dispatcher/user_dispatcher/$1/$2';
$route['(job|staff|roster|work|timesheet|payrun)/(:any)/(:any)'] = 'dispatcher/user_dispatcher/$1/$2/$3';
$route['(job|staff|roster|work|timesheet|payrun)/(:any)/(:any)/(:any)'] = 'dispatcher/user_dispatcher/$1/$2/$3/$4';
$route['(job|staff|roster|work|timesheet|payrun)/(:any)/(:any)/(:any)/(:any)'] = 'dispatcher/user_dispatcher/$1/$2/$3/$4/$5';
