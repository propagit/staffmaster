<tr class="<?=modules::run('timesheet/status_to_class', $timesheet['status']);?>" id="timesheet_<?=$timesheet['timesheet_id'];?>">
	...
	<td class="center">
		...
		- 
		<a href="#" class="ts_finish_time" data-type="combodate" data-template="DD- MM- YYYY HH: mm" data-format="YYYY-MM-DD HH:mm" data-viewformat="HH:mm" data-pk="<?=$timesheet['timesheet_id'];?>" data-value="<?=date('Y-m-d H:i', $timesheet['finish_time']);?>">
