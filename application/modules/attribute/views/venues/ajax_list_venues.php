<table class="table table-bordered table-hover table-middle table-expanded">
	<thead>
	<tr class="heading">
		<th class="left col-md-2">Venue Name <i class="fa fa-sort sort-venue" sort-data="name"></i></th>
		<th class="left col-md-3">Address</th>
        <th class="left col-md-1">Suburb <i class="fa fa-sort sort-venue" sort-data="suburb"></i></th>
        <th class="center col-md-1">Post Code <i class="fa fa-sort sort-venue" sort-data="postcode"></i></th>
		<th class="left col-md-2">Location <i class="fa fa-sort sort-venue" sort-data="location"></i></th>
