...
<div class="col-md-12">
	<div class="wp-page-invoice">
                ...
                <td>
                	<table cellpadding="10" cellspacing="0" width="100%">
                        ...
                        <tr class="charge-box-body">
                            <td>                                
                                <table cellpadding="0" cellspacing="0" width="100%" id="charge-details">
        ...
        <br />
        <hr />
        <table width="100%" cellpadding="10" id="list-items">
    	...
    	<div class="checkbox">
    		<input type="checkbox" id="full_breakdown" /> 
