                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="personal">
                            ...
                            <div class="row">
                              ...
                              <div class="row">   
                                    <div class="form-group col-md-6 <?=form_error('first_name')? ' has-error' : '';?>">
                                    ...
                                    <div class="form-group col-md-6 <?=form_error('last_name')? ' has-error' : '';?>">
                              ...
                              <div class="row">   
                                    <div class="form-group col-md-6 <?=form_error('gender')? ' has-error' : '';?>">
                              ...
                              <div class="row">   
                               ...
                               <div class="row"> 
                                    ...
                                    <div class="form-group col-md-6 <?=form_error('email_address')? ' has-error' : '';?>">
