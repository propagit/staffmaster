	...
	<div class="box bottom-box">
    	...
    	<div class="inner-box">    		
            <ul class="nav nav-tabs tab-respond" id="tab-search">
				<li class="<?=($search_shift_filters == '') ? 'active' : '';?>"><a href="#search-campaigns" data-toggle="tab">Search Campaigns</a></li>
				<li class="<?=($search_shift_filters == '') ? '' : 'active';?>"><a href="#find-shifts" data-toggle="tab">Find Shifts</a></li>
			</ul>
			
			
			<div class="tab-content">
				<!-- begin tab search campaigns -->
				<div class="tab-pane <?=($search_shift_filters == '') ? 'active' : '';?>" id="search-campaigns">
				...
				<div class="tab-pane <?=($search_shift_filters == '') ? '' : 'active';?>" id="find-shifts">
