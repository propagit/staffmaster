	...
	<div class="row">
		<div class="form-group">
			<div class="col-lg-3 col-lg-offset-3">
				<button type="button" class="btn btn-core" id="btn-shift-add-expense"><i class="fa fa-plus"></i> Add Expense</button>
			</div>
		</div>
	</div>
</form>
<script>
$(function(){
	$('#btn-shift-add-expense').click(function(){
		$('.form-group').removeClass('has-error');
		$.ajax({
			type: "POST",
			url: "<?=base_url();?>job/ajax_shift/add_expense",
