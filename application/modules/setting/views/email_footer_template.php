    ...
    <tr>
    	<td class="inside-template">
            ...
            <td width="50%" class="inside-template" style="padding:15px;">        	
                        ...
                        <br />
                        T: <?=(isset($company['email_c_telephone']) && $company['email_c_telephone']!='') ? $company['email_c_telephone'] : '';?> <br />
                        F: <?=(isset($company['email_c_fax']) && $company['email_c_fax']!='') ? $company['email_c_fax'] : '';?> <br />
                        E: <?=(isset($company['email_c_email']) && $company['email_c_email']!='') ? $company['email_c_email'] : '';?> <br />
                        W: <?=(isset($company['email_c_website']) && $company['email_c_website']!='') ? $company['email_c_website'] : '';?> <br />
            ...
            <td width="50%">
                ...
                <tr>
                    ...
                    <?=(isset($company['email_s_googleplus']) && $company['email_s_google']!='') ?  '<td align="right" width="3%"><a href="'.$company['email_s_google'].'"><img style="margin-right:3px;" src="'.base_url().'assets/img/google.png"></a></td>' : ''; ?> 
