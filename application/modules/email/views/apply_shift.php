        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-md-4 first-left">
                    <input type="text" class="form-control" id="apply_shift_email_from" name="apply_shift_email_from"/>
                </div>
                <label for="email_subject" class="col-md-2 control-label">Email Subject</label>
                <div class="col-md-4 last-right">
                    <input type="text" class="form-control" id="apply_shift_email_subject" name="apply_shift_email_subject"/>
                </div>
            </div>
        </div>
        <textarea id="email_apply_shift" name="email_apply_shift">
        	Dear [FIRST NAME] <br>
...
var email_apply_shift = CKEDITOR.replace('email_apply_shift',{
  height:300
});
