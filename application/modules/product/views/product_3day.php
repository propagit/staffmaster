...
<div class="pull-left">
		<div class="control-group">
			...
			<div class="controls">
				...
				<label class="radio">
					<input type="radio" name="ship_direction" value="DISTRIBUTOR"<?=(set_value('ship_direction') != 'DIRECT') ? ' checked' : '';?> onClick="switch_ship_direction()" /> Back to distributor
				</label>
			</div>
		</div>
...
<div class="clearfix"></div>
	...
	<? } ?>	
		<?
			...
			$page = $this->page_model->get_page_by_name('terms_of_sd');
		?>
		<div class="control-group">
			<label class="control-label" ></label>
			<div class="controls">
				<div class="well">
					<h4 class="c4"><?=$page['title'];?></h4>
					<p><?=$page['content'];?></p>
				</div>
			</div>
		</div>
